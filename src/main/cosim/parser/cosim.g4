...
for_stmt: FOR LP assign_body SEMI ID ( EQ | NEQ | GT | LT | GTE | LTE ) exp SEMI ((ID (SUB_SELF|ADD_SELF))|((SUB_SELF|ADD_SELF) ID)) RP compound_stmt ;
...
number: SUB? (INTEGER_LITERAL|REAL_LITERAL) ;
// Domain Values
